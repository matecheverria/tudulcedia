...
## 2. Repositorio y respaldo GitHub
...
Esta rama se creó desde `main` cuando el sistema ya tenía los últimos cambios de producción. Sirve como punto de recuperación si se rompe el sitio o se necesita volver a una versión estable.
...
## 6. Flujo cliente validado

Estado validado:

Cliente hace pedido → Apps Script registra pedido → se genera folio real TD-00XX → el cliente ve el folio en la pantalla final → el mensaje de WhatsApp incluye el folio → el pedido aparece en el dashboard admin.
...
## 8. Mensajes WhatsApp por estado
...
## 9. Commits importantes de producción
...
## 10. Procedimiento de recuperación rápida
...
El sistema queda documentado, con links finales limpios, backend identificado, ramas y archivos clave definidos, y un punto de recuperación en GitHub para emergencia.
